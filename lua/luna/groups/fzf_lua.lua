...
function M.get(c, opts)
  return {
    ...
    FzfLuaPromptBorder = { fg = c.surface, bg = c.bg },
    FzfLuaResultsBorder = { fg = c.surface, bg = c.bg },
    FzfLuaPreviewBorder = { fg = c.surface, bg = c.bg },
    FzfLuaTitle = { bg = c.silver, fg = c.bg },
    FzfLuaPromptPrefix = { fg = c.grey, bg = c.bg },
    ...
    FzfLuaScrollFloatEmpty = { bg = c.bg },
