...
function M.get(c, opts)
  return {
    ...
    FoldColumn = { fg = c.comment, bg = c.bg_soft },
    ...
    StatusLine = { fg = c.white, bg = c.bg_alt },
    StatusLineNC = { fg = c.silver, bg = c.bg_alt },
    TabLine = { fg = c.grey_pale, bg = c.black },
    TabLineFill = { fg = c.grey_mid },
    TabLineSel = { fg = c.ok, bg = c.black },
    Title = { fg = c.ok },
    Visual = { bg = c.visual },
    WinSeparator = { fg = c.bg_alt },
    MsgSeparator = { fg = c.float_bg, bg = c.bg },
